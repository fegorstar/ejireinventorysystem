...
if(isset($_POST["add_medicine_purchase"]))
{
    ...
    {
        $formdata['manufacturing_date'] = trim($_POST["manufacturing_date"]);
    }
    ...
    if($error == '')
    {
        ...
        $data = array(
            ...
            ':date_manufactured'       =>  $formdata['manufacturing_date'],
...
?>
                        ...
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Expired Drugs</h1>
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                   <li class="breadcrumb-item active">Expired Drugs</li>
                            </ol>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <i class="fas fa-table me-1"></i> Expired Drugs                                        </div>
