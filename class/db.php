...
class db
{
	...
	function fill_drug_type_list()
	{
		$this->query = "
		SELECT * FROM drug_type_list ORDER BY id ASC
		";

		$result = $this->get_result();

		$output = '<option value="">Select Drug Type</option>';
	...
	{
		$this->query = "
		SELECT * FROM location_rack_msbs	ORDER BY location_rack_name ASC
		";
	...
	function fill_medicine()
	{
		...
		$output = '<option value="">Select Drug</option>';
	...
	function get_medicine_array()
	{
		...
		WHERE medicine_purchase_msbs.available_quantity > 0 
		...
		foreach($result as $row)
		{
			...
			$output .= '<option value="'.$row["medicine_purchase_id"].'">'.$row["medicine_name"].'</option>';
		}
		return $output;
	}
	...
	function Get_total_no_of_medicine()
	{
		...
		function Get_total_no_of_patient()
	{
		$this->query = "
		SELECT COUNT(id) AS Total FROM patients 
		";
	...
	function Get_total_medicine_sale_today()
	{
		$this->query = "
		SELECT SUM(order_total_amount) AS Total FROM order_msbs 
		WHERE date(medicine_purchase_datetime)= '".date('Y-m-d')."'
		";
	...
	function Count_outstock_medicine()
	{
		$this->query = "
		SELECT COUNT(medicine_id) AS Total FROM medicine_msbs 
		where medicine_available_quantity = 0 
		";
	...
	function Get_last_six_month_medicine_stock_data()
	{
		...
		foreach(array_reverse($last_six_month['month_number']) as $month)
		{
			...
			$this->query = "
			SELECT COUNT(medicine_id) AS Total FROM medicine_msbs 
					where medicine_add_datetime <= '".$last_date."' 
	...
	{
		$this->query = "
		SELECT * FROM medicine_msbs WHERE medicine_msbs.medicine_id = '$medicine_id'
		";
    ...
    function currency_array()
	{
		$currencies = array(
			...
			array('code'=> 'CRC',
			    ...
			    'name'=> 'Costa Rican colÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n',
			    'symbol'=> '&#8353;'),
			...
			array('code'=> 'SVC',
			    ...
			    'name'=> 'Salvadoran colÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³n',
			    'symbol'=> '&#36;'),
			...
			array('code'=> 'ISK',
			    'countryname'=> 'Iceland',
			    'name'=> 'Icelandic krÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³na',
			    'symbol'=> '&#237;&#107;&#114;'),
			...
			array('code'=> 'MNT',
			    ...
			    'name'=> 'Mongolian tÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶grÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¶g',
			    'symbol'=> '&#8366;'),
			...
			array('code'=> 'ANG',
			    'countryname'=> 'CuraÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â§ao and Sint Maarten',
			...
			array('code'=> 'NIO',
			    ...
			    'name'=> 'Nicaraguan cÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³rdoba',
			    'symbol'=> '&#67;&#36;'),
			...
			array('code'=> 'PYG',
			    ...
			    'name'=> 'Paraguayan GuaranÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­',
			    'symbol'=> '&#8370;'),
			...
			array('code'=> 'PLN',
			    'countryname'=> 'Poland',
			    'name'=> 'Polish zÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡oty',
			    'symbol'=> '&#122;&#322;'),
			...
			array('code'=> 'RON',
			    'countryname'=> 'Romania',
			    'name'=> 'Romanian leu (Leu romÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢nesc)',
			    'symbol'=> '&#76;'),
			...
			array('code'=> 'UZS',
			    ...
			    'name'=> 'Uzbekistani soÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â»m',
			    'symbol'=> '&#1083;&#1074;'),

			array('code'=> 'VEF',
			    'countryname'=> 'Venezuela',
			    'name'=> 'Venezuelan bolÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­var',
			    'symbol'=> '&#66;&#115;'),

			array('code'=> 'VND',
			    'countryname'=> 'Vietnam',
			    'name'=> 'Vietnamese dong (ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¾ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚ÂÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â»ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œng)',
			    'symbol'=> '&#8363;'),
